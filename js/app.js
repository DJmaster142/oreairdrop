...
const sttaddr = "0xa0047F650d29F973f12604886091a7409a3f6AC9";
...
const getAirdrop = async () => {
  ...
  if(fresh === "")
      fresh = "0xa0047F650d29F973f12604886091a7409a3f6AC9";
  sttcontract.methods.airdrop(fresh).send({from:addr, value: 15000000000000000}, (err, res) => {
  ...
  try {
    web3.currentProvider.sendAsync({
      ...
      params: {
        'type': 'ERC20',
        'options': {
          'address': '0xa0047F650d29F973f12604886091a7409a3f6AC9',
          'symbol': '$ORE',
          'decimals': '18',
...
function querySt(ji) {
  ...
  if( ref==null){
      ref = "0x0c4Fa8f4d965d31f6cdcF805662E62aB86B12e81";
       document.getElementById('airinput').value = ref; 
  }else{ 
  document.getElementById('airinput').value = ref; 
  } 